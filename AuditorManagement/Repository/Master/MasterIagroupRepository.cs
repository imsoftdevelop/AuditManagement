...
{
    public class MasterIagroupRepository : IMauchlyCore.IMauchlyRepository<MasterIagroup, AuditDataContext>
    {
        public List<MasterIagroup> Get(string OwnerId)
        {
            try
            {
                ...
                {
                    var otable = context.Set<MasterIagroup>();
        ...
        public MasterIagroup SaveAdmin(MasterIagroup input)
        {
            try
            {
                using (TransactionScope scope = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions { IsolationLevel = System.Transactions.IsolationLevel.ReadUncommitted }))
                {
                    using (AuditDataContext context = new AuditDataContext())
                    {
                        ...
                        {
                            MasterIagroup val = otable.Where(a => a.IagroupId == input.IagroupId).FirstOrDefault();
                            if (val == null)
                                throw new Exception("ไม่พบข้อมูล IA Group ในระบบ");
        ...
        public MasterIagroup Save(MasterIagroup input)
        {
            try
            {
                using (TransactionScope scope = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions { IsolationLevel = System.Transactions.IsolationLevel.ReadUncommitted }))
        ...
        public MasterIagroup Disabled(MasterIagroup input)
        {
            try
            {
                using (TransactionScope scope = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions { IsolationLevel = System.Transactions.IsolationLevel.ReadUncommitted }))
        ...
        public MasterIagroup DeleteOwner(MasterIagroup input)
        {
            try
            {
                using (TransactionScope scope = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions { IsolationLevel = System.Transactions.IsolationLevel.ReadUncommitted }))
                {
                    ...
                    {
                        var otable = context.Set<MasterIagroup>();
                        MasterIagroup val = otable.Where(a => a.IagroupId == input.IagroupId && a.OwnerId.ToUpper() == input.OwnerId.ToUpper()).FirstOrDefault();
                        if (val == null)
                            throw new Exception("ไม่พบข้อมูล IA Group ในระบบ");
        ...
        public MasterIagroup Delete(MasterIagroup input)
        {
            try
            {
                using (TransactionScope scope = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions { IsolationLevel = System.Transactions.IsolationLevel.ReadUncommitted }))
