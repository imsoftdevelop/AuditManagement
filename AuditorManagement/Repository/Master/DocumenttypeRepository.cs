...
{
    public class DocumenttypeRepository : IMauchlyCore.IMauchlyRepository<Documenttype, AuditDataContext>
    {
        public List<Documenttype> Get(string OwnerId)
        {
            try
            {
                ...
                {
                    var otable = context.Set<Documenttype>();
        ...
        public Documenttype SaveAdmin(Documenttype input)
        {
            try
            {
                using (TransactionScope scope = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions { IsolationLevel = System.Transactions.IsolationLevel.ReadUncommitted }))
                {
                    using (AuditDataContext context = new AuditDataContext())
                    {
                        ...
                        {
                            Documenttype val = otable.Where(a => a.Documentid == input.Documentid).FirstOrDefault();
                            if (val == null)
                                throw new Exception("ไม่พบข้อมูล Document Type ในระบบ");
        ...
        public Documenttype Save(Documenttype input)
        {
            try
            {
                using (TransactionScope scope = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions { IsolationLevel = System.Transactions.IsolationLevel.ReadUncommitted }))
        ...
        public Documenttype Disabled(Documenttype input)
        {
            try
            {
                using (TransactionScope scope = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions { IsolationLevel = System.Transactions.IsolationLevel.ReadUncommitted }))
        ...
        public Documenttype DeleteOwner(Documenttype input)
        {
            try
            {
                using (TransactionScope scope = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions { IsolationLevel = System.Transactions.IsolationLevel.ReadUncommitted }))
                {
                    ...
                    {
                        var otable = context.Set<Documenttype>();
                        Documenttype val = otable.Where(a => a.Documentid == input.Documentid && a.OwnerId.ToUpper() == input.OwnerId.ToUpper()).FirstOrDefault();
                        if (val == null)
                            throw new Exception("ไม่พบข้อมูล Document Type ในระบบ");
        ...
        public Documenttype Delete(Documenttype input)
        {
            try
            {
                using (TransactionScope scope = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions { IsolationLevel = System.Transactions.IsolationLevel.ReadUncommitted }))
