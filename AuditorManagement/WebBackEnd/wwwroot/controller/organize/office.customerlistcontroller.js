angular.module('FOCUSAPP').controller('OfficeCustomerlistController', function ($stateParams, $rootScope, $state, $scope, $http, $timeout, $q, GlobalVar, globalService,
    ...
    $scope.init = function () {
        try {
            ...
            $("#loading").fadeIn();
            var qq = $q.all([serviceOrganize.getCustomerWithBranch(), serviceParameter.getParameterModel('all')]).then(function (data) {
                try {
    ...
    $scope.OnClickDisabledAssign = function () {
            
    }

    $scope.OnClickDeleteAssign = function () {
