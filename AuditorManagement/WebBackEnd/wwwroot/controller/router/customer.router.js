angular.module('customer.router', []).config(function ($stateProvider, $urlRouterProvider) {
    ...
    $stateProvider
        ...
        //    },
        //})
        .state('customer-confirmaccountreport', {
            url: "/customer-ConfirmAccountReport/:ref_id",
            views: {
                'container-view': {
                    templateUrl: "Customers/ConfirmAccountReport",
                    controller: "CustomerConfirmAccountPeriodAddController",
                    resolve: {
                        load: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                files: [
                                    'controller/customers/customer.confirmaccountperiodaddcontroller.js?noacche=' + makeid(),
                                    'controller/parameter/GlobalServiceControl.js?noacche=' + makeid(),
