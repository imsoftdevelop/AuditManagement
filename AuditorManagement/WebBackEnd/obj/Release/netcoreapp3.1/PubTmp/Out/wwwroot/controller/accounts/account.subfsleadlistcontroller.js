                    ...
                    try {
                        ...
                        if (data[0] != undefined && data[0] != "") {
                            if (data[0].data.responsecode == '200' && data[0].data.responsedata != undefined && data[0].data.responsedata != "") {
                                ...
                                $scope.TablePeriod.Footer.Current = $scope.TablePeriod.AccountSelect.Current;
                                $scope.TablePeriod.Footer.Debit = $scope.TablePeriod.AccountSelect.Debit;
                                $scope.TablePeriod.Footer.Credit = $scope.TablePeriod.AccountSelect.Credit;
                                $scope.TablePeriod.Footer.Audit = $scope.TablePeriod.AccountSelect.Audit;
                                $scope.TablePeriod.Footer.Previous = $scope.TablePeriod.AccountSelect.Previous;
