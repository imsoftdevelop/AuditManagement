angular.module('FOCUSAPP').controller('AdminRequestFormController', function ($scope, $http, $timeout, GlobalVar, $q, globalService, serviceBilling) {
    ...
    var gRequest = serviceBilling.getRequestFormProcess();
                ...
                try {
                    if (data[0] != undefined && data[0] != "") {
                        if (data[0].data.responsecode == 200) {
                            var qq = $q.all([serviceBilling.getRequestFormProcess()]).then(function (data) {
                                try {
                                    if (data[0] != undefined && data[0] != "") {
                                        if (data[0].data.responsecode == 200) {
                                            $scope.TableMain = data[0].data.responsedata;
