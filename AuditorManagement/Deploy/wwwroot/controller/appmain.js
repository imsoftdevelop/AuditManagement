var FOCUSAPP = angular.module('FOCUSAPP', ['ngFileUpload', 'ui.router', 'owner.route', 'oc.lazyLoad', 'ngAnimate', 'admin.route', 'office.router', 'account.router', 'audit.router', 'manager.router','customer.router']);
